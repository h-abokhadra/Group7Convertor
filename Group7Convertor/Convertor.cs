...
namespace Group7Convertor
{
    class Convertor
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Press 5 for Addition \n");
            Console.WriteLine("Press 6 for Subtraction \n");
            Console.WriteLine("Press 7 for Multiplication\n");
            Console.WriteLine("Press 8 for Addition \n");
            Console.WriteLine("Press 9 for Subtraction \n");
